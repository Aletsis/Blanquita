...
public interface IPrintingService
{
    ...
    Task PrintReturnTicketAsync(ReturnDto returnDto, string printerIp, int printerPort, CancellationToken cancellationToken = default);
    Task PrintPedidoTicketAsync(PedidoDto pedidoDto, string printerIp, int printerPort, CancellationToken cancellationToken = default);
