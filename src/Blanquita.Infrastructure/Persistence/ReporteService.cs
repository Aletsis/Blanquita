...
namespace Blanquita.Infrastructure.Persistence;

/// <summary>
/// Servicio de persistencia para reportes históricos usando archivos JSON.
/// Implementa almacenamiento local en el sistema de archivos.
/// </summary>
public class ReporteService : IReporteService
{
    private readonly string _rutaHistorico;
    private List<ReporteDto> _reportesCache;
    ...
    public ReporteService()
    {
        ...
        _reportesCache = new List<ReporteDto>();
        CargarReportes();
    }

    public async Task GuardarReporteAsync(ReporteDto reporte)
    {
        await Task.Run(() =>
        {
            // Generar ID único
    ...
    public async Task<ReporteDto?> ObtenerReportePorIdAsync(int id)
    {
    ...
    public async Task<List<ReporteDto>> BuscarReportesAsync(string? sucursal = null, DateTime? fechaInicio = null, DateTime? fechaFin = null)
    {
    ...
    public async Task ActualizarReporteAsync(ReporteDto reporte)
    {
        await Task.Run(() =>
        {
            var nombreArchivo = $"Reporte_{reporte.Id}_{reporte.Sucursal}_{reporte.Fecha:yyyyMMdd}.json";
        ...
        try
        {
            ...
            foreach (var archivo in archivos)
            {
                try
                {
                    ...
                    var reporte = JsonSerializer.Deserialize<ReporteDto>(json);
